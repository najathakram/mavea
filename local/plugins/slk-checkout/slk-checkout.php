...
add_action(
	...
	static function () {
		...
		require_once SLK_CHECKOUT_PATH . 'includes/class-slk-customization.php';
		require_once SLK_CHECKOUT_PATH . 'includes/class-slk-customization-cart.php';
		require_once SLK_CHECKOUT_PATH . 'includes/class-slk-customization-admin.php';
		...
		SLK_Customization_Cart::init();
		SLK_Customization_Admin::init();
	},
	5
);
